...
function DashboardRoute() { const { setCompanyStatus } = useOutletContext(); return <DashboardPage onStatusChange={setCompanyStatus} />; }
    ...
    <Route element={<ProviderBoundary />}>
      ...
      <Route element={<RequireAuth />}><Route element={<RequireOrganization />}><Route element={<AuthenticatedLayout />}>
        ...
        <Route path="obras/:obraId" element={<ObraWorkspaceLayout />}>
          ...
          <Route path="resumen" element={<ObraWorkspaceSection title="Resumen" />} />
          <Route path="operacion" element={<OperacionPage />} />
          <Route path="indicadores" element={<ObraWorkspaceSection title="Indicadores" />} />
          <Route path="problemas" element={<ObraWorkspaceSection title="Problemas y acciones" />} />
          <Route path="evidencias" element={<ObraWorkspaceSection title="Evidencias" />} />
          <Route path="timeline" element={<ObraWorkspaceSection title="Timeline" />} />
          <Route path="informes" element={<ObraWorkspaceSection title="Informes" />} />
        </Route>

...
export function EmptyState({
    ...
    return (
        <section
            className={`relative flex w-full flex-col justify-center overflow-hidden rounded-[var(--radius-lg)] border border-emerald-100/90 bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.10),transparent_48%),linear-gradient(180deg,var(--bg-surface),var(--bg-surface-subtle))] p-8 text-center shadow-[0_14px_36px_rgba(15,23,42,0.06)] ${className}`}
        >

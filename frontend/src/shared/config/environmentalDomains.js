...
export const ENVIRONMENTAL_DOMAINS = {
  ...
  materiales: { key: "materiales", label: "Materiales", icon: Package, text: "text-emerald-700", softBg: "bg-emerald-50", border: "border-emerald-200", accent: "from-emerald-50 via-green-50/40 to-white" },
  residuos: { key: "residuos", label: "Residuos", icon: Trash2, text: "text-amber-800", softBg: "bg-amber-50", border: "border-amber-300", accent: "from-amber-50 via-orange-50/45 to-white" },

const modules = [
  { key: "constructoras", label: "Empresas / constructoras", supported: true, backendKind: "constructoras", columns: ["constructora_id", "nombre", "rut", "region", "comuna", "direccion", "rubro", "email", "telefono", "contacto", "observaciones"] },
  ...
  { key: "etapas", label: "Etapas", supported: true, backendKind: "etapas", columns: ["etapa_id", "constructora_id", "nombre", "tipo", "region", "comuna", "estado", "observaciones"] },
  { key: "obras", label: "Obras", supported: true, backendKind: "obras", columns: ["codigo_obra", "constructora_id", "etapa_id", "nombre", "tipo_proyecto", "fecha", "superficie_m2", "ubicacion", "observaciones"] },

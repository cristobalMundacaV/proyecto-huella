        ...
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <div className="rounded-2xl border border-slate-700 bg-slate-950 px-4 py-3 text-sm font-bold text-slate-200">
              {formatNumber(selectedLote.documentos?.length || 0, 0)} documentos
            </div>
            <button
              type="button"
            ...
            >
              <div className="min-w-0">
                ...
                >
                  ...
                  {documento.archivo?.split("/").pop() || "Ver archivo"}
                </a>
                <button
                  type="button"
                  onClick={() => onRunOcr(documento.id)}
                  disabled={readingDocumentId === documento.id}
                ...
                >
                  {readingDocumentId === documento.id ? (
                ...
                <button
                  type="button"
                  onClick={() => onRunStructuredExtraction(documento.id)}
                  disabled={extractingDocumentId === documento.id}
                ...
                >
                  {extractingDocumentId === documento.id ? (
                    <Loader2 className="animate-spin" size={16} />
                  ) : (
                    <FileText size={16} />
                  )}
              ...
              <div
                className={`h-fit rounded-2xl border px-4 py-2 text-sm font-bold ${
                  documentStatusTone[documento.estado_validacion] ||

...
export default function OrganizationSelectionPage() {
  const navigate = useNavigate(); const { user } = useAuth(); const { organizaciones, loadingOrganizaciones, setActiveOrganizacion } = useOrganizacionActiva();
  ...
  if (user?.is_superuser) return <Navigate to="/saas" replace />;

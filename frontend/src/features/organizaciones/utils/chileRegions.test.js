...
import { CHILE_REGIONS, getComunasByRegion, isValidChileLocation, selectChileRegion } from "./chileRegions.js";
...
test("cambiar región limpia la comuna anterior", () => { assert.deepEqual(selectChileRegion("Región de Ñuble"), { region: "Región de Ñuble", comuna: "" }); });

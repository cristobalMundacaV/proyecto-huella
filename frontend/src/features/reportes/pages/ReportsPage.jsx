    ...
    <CZPageHero>
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-emerald-50/85">Analiza la evolución ambiental de la obra, compara resultados entre períodos y convierte la información en decisiones de mejora.</p>
          <div className="mt-4 flex flex-wrap gap-2">
            <HeroPill>{workName}</HeroPill>
            <HeroPill>{periodLabel}</HeroPill>
            <HeroPill>{report.comparison.available ? `vs. ${report.comparison.previousLabel}` : "Sin comparación disponible"}</HeroPill>

function ImportHero({ activeOrganizacion, config, preset }) {
  return (
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="flex flex-wrap gap-2">
            <span className="rounded-full border border-emerald-200 bg-white px-3 py-1 text-xs font-black uppercase tracking-wide text-emerald-700">{activeOrganizacion?.nombre || "Empresa activa"}</span>

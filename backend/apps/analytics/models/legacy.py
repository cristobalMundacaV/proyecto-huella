...
# Preserve historical migration serialization paths exposed by the public models API.
documento_ambiental_upload_path.__module__ = "apps.analytics.models"
evidencia_formatos_default.__module__ = "apps.analytics.models"

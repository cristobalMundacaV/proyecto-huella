...
class EvidenciaObra(models.Model):
    class TipoEvidencia(models.TextChoices):
        ...
        FACTURA_AGUA = "factura_agua", "Factura o boleta sanitaria"
        LECTURA_MEDIDOR_AGUA = "lectura_medidor_agua", "Lectura de medidor de agua"
        ABASTECIMIENTO_ALJIBE = "abastecimiento_camion_aljibe", "Abastecimiento por camion aljibe"
        EXTRACCION_AGUA_PROPIA = "extraccion_agua_propia", "Extraccion propia de agua"
        INFORME_HIDRICO = "informe_hidrico", "Informe o certificado hidrico"
        LECTURA_MEDIDOR_ELECTRICO = "lectura_medidor_electrico", "Lectura de medidor electrico"
        REPORTE_GENERACION = "reporte_generacion", "Reporte de generacion"
        REPORTE_INVERSOR = "reporte_inversor_energia", "Reporte de inversor o sistema energetico"
        VALE_COMBUSTIBLE = "vale_combustible", "Vale o comprobante de combustible"
        REGISTRO_ABASTECIMIENTO = "registro_abastecimiento", "Registro de abastecimiento"
        REGISTRO_ESTANQUE = "registro_estanque_telemetria", "Registro de estanque o telemetria"
        HOJA_RUTA = "hoja_ruta", "Hoja o ficha de ruta"
        REGISTRO_GPS = "registro_gps_kilometraje", "Registro GPS o kilometraje"
        COMPROBANTE_DESPACHO = "comprobante_despacho", "Comprobante de despacho"
        HOROMETRO = "horometro", "Horometro"
        PARTE_DIARIO_MAQUINARIA = "parte_diario_maquinaria", "Parte diario de maquinaria"
        REGISTRO_MANTENIMIENTO = "registro_mantenimiento", "Registro de mantenimiento"
        EPD = "epd_material", "Declaracion ambiental de producto"
        MANIFIESTO_RETIRO = "manifiesto_retiro", "Manifiesto o guia de retiro"
        CERTIFICADO_DISPOSICION = "certificado_disposicion_final", "Certificado de disposicion final"
        INFORME_GESTOR = "informe_gestor_residuos", "Informe del gestor"
        INFORME_RUIDO = "informe_medicion_ruido", "Informe de medicion de ruido"
        REGISTRO_SONOMETRO = "registro_sonometro", "Registro de sonometro"
        CALIBRACION_SONOMETRO = "calibracion_sonometro", "Calibracion de sonometro"
        INFORME_MUESTREO = "informe_muestreo_atmosferico", "Informe de muestreo"
        INFORME_LABORATORIO = "informe_laboratorio_atmosferico", "Informe de laboratorio"
        MEDICION_INSTRUMENTAL = "medicion_instrumental_atmosferica", "Medicion instrumental"
        INFORME_MONITOR = "informe_monitor_ambiental", "Informe de monitor o sensor"
        OTRO = "otro", "Otro"

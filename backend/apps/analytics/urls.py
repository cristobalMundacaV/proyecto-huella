...
urlpatterns = [
    ...
    path("organizaciones/<str:organizacion_id>/factores-ambientales/<int:factor_id>/versiones/", factor_versions),
    path("organizaciones/<str:organizacion_id>/factores-ambientales/<int:factor_id>/versiones/<int:version_id>/", factor_version_detail),
    path("organizaciones/<str:organizacion_id>/factores-ambientales/<int:factor_id>/versiones/<int:version_id>/transicion/", factor_version_transition),
    path(

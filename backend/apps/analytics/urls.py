...
from .views_construction_v1 import (environmental_work, work_context_view,
                                    work_indicators, work_materials,
                                    work_timeline)
...
from .views_quality_v2 import (calidad_observaciones, comparacion_indicador,
                               ...
                               serie_indicador)
from .views_copilot_v2 import (agent_problem_proposals, agent_proposal_feedback,
                               agent_reevaluation_draft, confirm_copilot_command,
                               context_asset, context_asset_maintenance,
                               context_evidence, context_indicator_history,
                               context_organization_memory, context_problem,
                               context_sensor_health)
from .views_professional_v2 import (auditoria, expediente_close, expediente_detail,
                                    expediente_reopen, expedientes, informe_detail,
                                    informe_pdf, informe_validate, informes,
...
urlpatterns = [
    ...
    path("organizaciones/<str:organizacion_id>/viajes-operacionales/<int:journey_id>/", journey_detail),
    ...
    path("organizaciones/<str:organizacion_id>/revisiones-profesionales/<int:revision_id>/decision/", revision_decision),
    ...
    path("organizaciones/<str:organizacion_id>/expedientes/<int:expediente_id>/", expediente_detail),
    path("organizaciones/<str:organizacion_id>/expedientes/<int:expediente_id>/cerrar/", expediente_close),
    path("organizaciones/<str:organizacion_id>/expedientes/<int:expediente_id>/reabrir/", expediente_reopen),
    path("organizaciones/<str:organizacion_id>/informes/", informes),
    path("organizaciones/<str:organizacion_id>/informes/<int:informe_id>/", informe_detail),
    path("organizaciones/<str:organizacion_id>/informes/<int:informe_id>/pdf/", informe_pdf),
    path("organizaciones/<str:organizacion_id>/informes/<int:informe_id>/validar/", informe_validate),
    ...
    path("context/organizations/<str:organization_id>/memory/", context_organization_memory),
    path("agent/problems/<int:problem_id>/proposals/", agent_problem_proposals),
    path("agent/problems/<int:problem_id>/proposals/<int:proposal_id>/feedback/", agent_proposal_feedback),
    path("agent/problems/<int:problem_id>/reevaluation-draft/", agent_reevaluation_draft),
    ...
    path("organizaciones/<str:organizacion_id>/obras/<int:obra_id>/ambiental/", environmental_work),
    path("organizaciones/<str:organizacion_id>/obras/<int:obra_id>/timeline/", work_timeline),
    path("organizaciones/<str:organizacion_id>/obras/<int:obra_id>/indicadores/", work_indicators),
    path("organizaciones/<str:organizacion_id>/obras/<int:obra_id>/materiales/", work_materials),
    path("organizaciones/<str:organizacion_id>/obras/<int:obra_id>/contexto/", work_context_view),
    ...
    path("organizaciones/<str:organizacion_id>/registros-emision/", organizacion_registros_emision),
    path("organizaciones/<str:organizacion_id>/registros-emision/<int:registro_id>/aplicar-factor/", organizacion_registro_aplicar_factor),
    path("organizaciones/<str:organizacion_id>/emisiones/", organizacion_emisiones),
    path("organizaciones/<str:organizacion_id>/acciones-ambientales/resumen/", organizacion_acciones_ambientales_resumen),
    path("organizaciones/<str:organizacion_id>/acciones-ambientales/", organizacion_acciones_ambientales),
    path("organizaciones/<str:organizacion_id>/acciones-ambientales/<int:action_id>/", organizacion_accion_ambiental_detail),
    path("organizaciones/<str:organizacion_id>/lotes-forestales/", organizacion_lotes_forestales),
    path("organizaciones/<str:organizacion_id>/lotes-forestales/resumen/", organizacion_lotes_forestales_resumen),
    path("organizaciones/<str:organizacion_id>/lotes-forestales/<str:lote_id>/transportes/", organizacion_lote_forestal_transportes),
    path("organizaciones/<str:organizacion_id>/lotes-forestales/<str:lote_id>/", organizacion_lote_forestal_detail),
    path("organizaciones/<str:organizacion_id>/evidencias/", organizacion_evidencias),
    path("organizaciones/<str:organizacion_id>/evidencias/extraer/", organizacion_evidencia_extraer),
    path("organizaciones/<str:organizacion_id>/reportes/", organizacion_reportes),
    path("organizaciones/<str:organizacion_id>/documentos-ambientales/", documentos_ambientales),
    path("organizaciones/<str:organizacion_id>/documentos-ambientales/<int:documento_id>/", documento_ambiental_detail),
    path("organizaciones/<str:organizacion_id>/variables-ambientales/", variables_ambientales),
    path("organizaciones/<str:organizacion_id>/variables-ambientales/<int:variable_id>/", variable_ambiental_detail),
    path("organizaciones/<str:organizacion_id>/limites-ambientales/", limites_ambientales),
    path("organizaciones/<str:organizacion_id>/limites-ambientales/<int:limite_id>/", limite_ambiental_detail),
    ...
    path("environmental/decisions/priorities/<str:organizacion_id>/", environmental_decision_priorities),
    path("environmental/executive-report/<str:organizacion_id>/", environmental_executive_report),
    path("environmental/ingestion-readiness/<str:organizacion_id>/", environmental_ingestion_readiness),
    path("environmental/decisions/priorities/<str:organizacion_id>/<str:priority_id>/action-preview/", environmental_decision_action_preview),
    path("environmental/decisions/priorities/<str:organizacion_id>/<str:priority_id>/create-action/", environmental_decision_create_action),
    ...
    path("organizaciones/<str:organizacion_id>/importaciones/<str:kind>/preview/", importacion_preview),
    path("organizaciones/<str:organizacion_id>/importaciones/<str:kind>/confirm/", importacion_confirm),

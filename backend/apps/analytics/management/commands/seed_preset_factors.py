...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        rows = [
            ...
            ("forestal", "recepcion_trozas", "Materia prima", "Recepcion de trozas referencial", "m3", "0.000000"),
            ("forestal", "produccion", "Produccion", "Produccion aserradero referencial", "m3 procesados", "0.000000"),
            ("forestal", "secado", "Secado", "Secado energia referencial", "kWh", "0.000000"),
            ("forestal", "energia", "Energia", "Energia aserradero referencial", "kWh", "0.000000"),
            ("forestal", "transporte_forestal", "Transporte", "Diesel transporte forestal referencial", "litros diesel", "0.000000"),
            ("forestal", "residuos_subproductos", "Subproductos", "Residuos valorizacion referencial", "kg", "0.000000"),
